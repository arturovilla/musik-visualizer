...
uniform float uTime;
uniform float uAvgAudioFrequency;
...
// ALL OF THIS IS CALLED THE MVP (MODEL, VIEW, PROJECTION)
// transforms -> postion , scale and rotation
// projectionMatrix -> projects our object onto screeen (aspect ratio & perspective)
// modelMatrix -> position , scale , and rotation of our object
...
void main() {
  ...
  // add the normalized fequency to the normal segment here 
